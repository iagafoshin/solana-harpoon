...
[Read more about Generating Old Faithful archives.](https://docs.old-faithful.net/running-old-faithful/sourcing-data/generating-from-rocksdb)
...
Triton provides a full copy of this ledger at [**https://files.old-faithful.net**](https://files.old-faithful.net/) that you can download to get started without needing to build the CAR's from the RocksDB archives yourself.

[Read more about hosting your own copy of Old Faithful archives.](https://docs.old-faithful.net/running-old-faithful)
...
[Read more about running the Old Faithful RPC server.](https://docs.old-faithful.net/usage/rpc-server)
...
[Read more about the various data sources available.](https://docs.old-faithful.net/running-old-faithful/sourcing-data)
...
* Run warehouse nodes to [generate new car files continuously from Solana ledger copies](https://docs.old-faithful.net/running-old-faithful/sourcing-data/generating-from-rocksdb/warehouse-nodes)
* If you want a full or partial historical archive, you can:
  * [Generate your own archive from historical ledger copies](https://docs.old-faithful.net/running-old-faithful/sourcing-data/generating-from-rocksdb/historical-blocks)
  * [Clone OF1](https://docs.old-faithful.net/running-old-faithful/sourcing-data/of1)
...
Read more about OF1 [here](https://docs.old-faithful.net/running-old-faithful/sourcing-data/of1).
...
\
The [of1-files](https://docs.old-faithful.net/references/of1-files "mention") page has an index of all the files in each epoch.
...
* [Faithful](http://github.com/rpcpool/yellowstone-faithful), used for running the [RPC server ](https://docs.old-faithful.net/usage/rpc-server)and [creating the necessary indexes](https://docs.old-faithful.net/running-old-faithful/sourcing-data/generating-from-rocksdb/creating-indexes) for the RPC server
* [Radiance](http://github.com/rpcpool/radiance-triton-faithful/), used for processing[ warehouse nodes’ ledger  archives and producing CAR files](https://docs.old-faithful.net/running-old-faithful/sourcing-data/generating-from-rocksdb/warehouse-nodes)
* [PoH check car,](https://github.com/rpcpool/poh-check-car) used for [validating PoH of Old Faithful](https://docs.old-faithful.net/usage/validation) car files.

You can also [interact with Old Faithful through standard Filecoin tooling](https://docs.old-faithful.net/running-old-faithful/installation-and-setup/configuration-files/filecoin-v1-retrievals) like [Lassie](https://github.com/filecoin-project/lassie).
...
\
To understand why this is the case, read [here](https://docs.old-faithful.net/running-old-faithful/installation-and-setup/building-old-faithful/jsonparsed-support).
...
* [OF1](https://docs.old-faithful.net/running-old-faithful/sourcing-data/of1)
* [Filecoin](https://docs.old-faithful.net/running-old-faithful/sourcing-data/filecoin)
* [Generating from RocksDB](https://docs.old-faithful.net/running-old-faithful/sourcing-data/generating-from-rocksdb)
...
* `data`: retrieval configuration for the block/transaction data&#x20;
  * `car`: used for [Filecoin v1,](https://docs.old-faithful.net/running-old-faithful/installation-and-setup/configuration-files/filecoin-v1-retrievals) [http](https://docs.old-faithful.net/running-old-faithful/installation-and-setup/configuration-files/http), and [local file system](https://docs.old-faithful.net/running-old-faithful/installation-and-setup/configuration-files/local-file-system) retrievals
  * `filecoin`: used for [Filecoin v2](https://docs.old-faithful.net/running-old-faithful/installation-and-setup/configuration-files/filecoin-v2-retrievals) retrievals
...
If your file system or network file system store does not like serving large files, you can configure split retrievals for the local file system in the same way they work for [HTTP retrievals](https://docs.old-faithful.net/running-old-faithful/installation-and-setup/http#split-retrievals-advanced).
...
Old Faithful ships with an RPC server that supports [gRPC](https://docs.old-faithful.net/references/grpc-methods) and [JSON-RPC](https://docs.old-faithful.net/references/rpc-methods).&#x20;
...
Old Faithful supports full validation of Proof of History. In OF1, every epoch’s PoH has been validated with one exception (see [Epoch 208](https://docs.old-faithful.net/usage/validation/epoch-208)).  Outputs from our validation of the history can be found at <https://files.old-faithful.net/\\><epoch>/poh-check-\<epoch>.log.&#x20;
...
Since the ledger data [for about 495 slots (89856108 and 89856602) is missing](https://docs.old-faithful.net/running-old-faithful/sourcing-data/generating-from-rocksdb/historical-blocks#epoch-208), we do not have PoH data for these slots. This means that the [PoH validation](https://docs.old-faithful.net/usage/validation) that was conducted on the other slots could not be completed.
...
The [OF1](https://docs.old-faithful.net/running-old-faithful/sourcing-data/of1) files have this transition at **epoch 157** but this can/will be different for other warehousing systems.
...
* [getSlot](https://solana.com/docs/rpc/http/getslot)
* [getVersion](https://solana.com/docs/rpc/http/getversion)
* [StreamTransactions](https://docs.old-faithful.net/references/examples#oldfaithful.oldfaithful-streamtransactions)
* [StreamBlocks](https://docs.old-faithful.net/references/examples#oldfaithful.oldfaithful-streamblocks)
